...
const CONTRACT_ADDRESS = '0xEBF08bc1D4C2eC68830e77c8212CAF0DB34ff1e0'; 
const data = [
          ...
          {active && (
            ...
            >
              <Image
                ...
                className=" w-20"
              />
              <motion.p className="text-black pb-4 pt-2"> FWCC token  </motion.p>
            </div>
          )}
          {!active && (
            <div
                ...
                <div className="block rounded-xl bg-white opacity-90 p-4 sm:p-6 lg:p-8">
                  <div className="mt-10">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                     {t("tokensventa")}<p className="bold">1,000,000 FWCC</p>
                    </p>
                    <p className="mt-2 text-sm text-gray-500">
